                ...
                <div class="card-box">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="#custom-modal" data-animation="door" data-plugin="custommodal" data-overlaySpeed="200" data-overlayColor="#36404a" onclick="abrir_modal('Editar {{$dato->nombre}}', '2', ['nombre'], {{$dato}});" title="Editar"><i class="fa fa-edit"></i></a>
...
<!-- end wrapper -->
 ...
 <div id="custom-modal" class="modal-demo">
    ...
    <div class="custom-modal-text text-left">
        <form role="form" method="POST" action="{{route('modulos_index_post')}}" name="form">
